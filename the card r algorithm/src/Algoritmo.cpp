...
Algoritmo::Algoritmo(size_t inicializacoes, size_t clusters, size_t q, size_t limite, const Repositorio& repositorio, ostream& out) :
  inicializacoes(inicializacoes), clusters(clusters), prototipos(prototipos), repositorio(repositorio), out(out) {
    melhor = atual = Resultado(clusters, repositorio.tabela[0].n, q, 0);
